...
namespace Microsoft.Practices.ServiceLocation
{
    ...
    public abstract class ServiceLocatorImplBase : IServiceLocator
    {
        ...
        /// <summary>
        /// Format the exception message for use in an <see cref="ActivationException"/> that occurs while resolving a single service.
        /// </summary>
        ...
        /// <summary>
        /// Format the exception message for use in an <see cref="ActivationException"/> that occurs while resolving multiple service instances.
        /// </summary>
        /// <param name="actualException">The actual exception thrown by the implementation.</param>
        /// <param name="serviceType">Type of service requested.</param>
        /// <returns>The formatted exception message string.</returns>
